function Calendar(c){
    ...
    calendarTemplate = `
		...
		<div class="months-container">
			...
			<p class="APR">Nisan</p>
			<p class="MAY">Mayis</p>
			<p class="JUN">Haziran</p>
			<p class="JUL">Temmuz</p>
			<p class="AUG">Agustos</p>
			<p class="SEP">Eyul</p>
			<p class="OCT">Ekim</p>
			<p class="NOV">Kasim</p>
			<p class="DEC">Aralik</p>
	...
	let m = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'OCAK', 'SUBAT', 'MART', 'NiSAN', 'MAYIS', 'HAZiRAN', 'TEMMUZ', 'AGUSTOS', 'EYLUL', 'EKiM', 'KASIM', 'ARALIK'];
	let months = new Map();
...
// year selector
	...
	this.getSelectedDate = function(){
		return {
			...
			'day' : selectedDay,
			'year' : currentYear,
			'fullDate' : `${m[currentMonth+12]} ${selectedDay} ${currentYearf}`
		};
	}
